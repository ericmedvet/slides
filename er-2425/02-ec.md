...
- a first representation:
  - genotype-phenotype $\\phi\\sub{1}: G\\sub{1} \\to S\\sub{1}$
  - builder $B\\sub{1} \\in \\mathcal{P}\\sub{S\\sub{1}}$
  - genetic operators $o\\sub{\\text{mut},1}: S \\to \\mathcal{P}\\sub{S\\sub{1}}$ and $o\\sub{\\text{xover},1}: S \\times S \\to \\mathcal{P}\\sub{S\\sub{1}}$
- a second representation:
  - genotype-phenotype $\\phi\\sub{2}: G\\sub{2} \\to S\\sub{2}$
  - builder $B\\sub{2} \\in \\mathcal{P}\\sub{S\\sub{2}}$
  - genetic operators $o\\sub{\\text{mut},2}: S \\to \\mathcal{P}\\sub{S\\sub{2}}$ and $o\\sub{\\text{xover},2}: S \\times S \\to \\mathcal{P}\\sub{S\\sub{2}}$
- a way to compose two parts of the solution $\\oplus: S\\sub{1} \\times S\\sub{2} \\to S$

then, you can build a representation for $S$ as:
- $\\phi: G\\sub{1} \\times G\\sub{2} \\to S$ working as $(g\\sub{1},g\\sub{2}) \\mapsto \\oplus(\\phi\\sub{1}(g\\sub{1}), \\phi\\sub{2}(g\\sub{2}))$
<!-- complete! -->
