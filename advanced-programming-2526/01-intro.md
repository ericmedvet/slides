...
**T**: fondamenti di informatica; ML operations  
...
**T**: safe and verified AI; information retrieval and data visualization; lab di programmazione I and II\*  
...
**T**: programmazione ad oggetti; machine learning; evolutionary robotics  
...
Teacher slides:
- available [here](https://medvet.inginf.units.it/teaching/2526-advancedprogramming/)
...
.note[See the [syllabus](https://medvet.inginf.units.it/teaching/2526-advancedprogramming/)!]
...
.cols[
.c40[
We are currently at version **25**:
- last LTS¹ is **25**
- coming in days: **26**
...
drwxr-xr-x  4 root root  4096 feb  6 12:08 lib
...
```
